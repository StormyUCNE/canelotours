  ...
  return (
    <div className="HeroContainer">
      ...
      <div className="HeroContent">
        <img className="Logo" src={Logo}  alt="Hero Logo" fetchPriority="high" loading="eager" decoding="async" width={300} height={188} />
        ...
        <img className="Payments" src={Paymentmethods} fetchPriority="high" loading="eager" decoding="async" alt="Payment methods" width={600} height={70} />
      </div>
    </div>
  )
}
